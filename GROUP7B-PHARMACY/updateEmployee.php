...
<head>
  ...
  <title>Employee Update | Group7B-Pharmacy</title>
  <!-- Font Awesome -->
...
<div class="card">
        ...
        <h5 class="card-header info-color white-text text-center py-4">
            <strong>UPDATE EMPLOYEE | Group7B-Pharmacy</strong>
        </h5>
        ...
        <div class="card-body px-lg-5 pt-0">
            ...
            <form class="text-center" style="color: #757575;" action="addEmployee.php" name="addEmployee">
                ...
                <!-- Sign up button -->
                <button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit">UPDATE EMPLOYEE</button>
