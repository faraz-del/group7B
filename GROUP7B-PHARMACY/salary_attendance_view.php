...
<table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
    <thead>
        <tr>
            ...
            <th class="th-sm">payroll Year</th>
            <th class="th-sm">payroll Month</th>
            <th class="th-sm">Bonus</th>
            <th class="th-sm">Tax</th>
            <th class="th-sm">Full Payment</th>
    ...
    <?php while ($row = $result->fetch_assoc()): ?>
        <tr>
            ...
            <td><a href="?edit=<?php echo $row['payslipId']; ?>" class="btn btn-info">Edit</a></td>
			<td><a href="?delete=<?php echo $row['payslipId']; ?>" class="btn btn-danger">Delete</a></td>
