...
<table>
    <tr>
      <td><canvas id="barChart" style="max-width: 1800px;"></canvas></td>
      <td><canvas id="pieChart" style="max-width: 1800px;"></canvas></td>
    </tr>
  </table>
...
<div class="container text-center text-md-left">
  ...
  <div class="row text-center text-md-left mt-3 pb-3">
    ...
    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
      ...
      <p>
        <i class="fas fa-envelope mr-3"></i>Group7B-Pharmacy@info.com</p>
      <p>
