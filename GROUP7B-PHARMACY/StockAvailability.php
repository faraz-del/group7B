...
<head>
  ...
  <title>Stock Reports | Group7B-Pharmacy</title>
  <!-- Font Awesome -->
...
<?php
if ($row && is_array($row) && array_key_exists('ItemQuantity', $row)) {
...
<?php
    ...
    // Handle the case where $row is null or does not have the expected structure
    echo "Item data is not in the expected format.";
}
?>
