        ...
        <form id="myform4" method="POST">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="reportid" placeholder="ReportID">
            </div>
            <!-- Default input -->
            <div class="form-group col-md-6">
              <label for="supplireid">SupplireID</label>
              <input type="text" class="form-control" id="supplireid" placeholder="SupplireID">
            </div>
          </div>
          <!-- Grid row -->
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="medName" placeholder="SPC,MPC,ACC">
          </div>
          <!-- Default input -->
          <div class="form-group">
          ...
          <!-- Grid row -->
          <button type="submit" class="btn btn-primary btn-md" onclick="javascript: return validateReportForm();">UPDATE</button>
          <button type="submit" class="btn btn-primary btn-md" onclick="javascript: return validateReportForm();">REMOVE</button>
        </form>
